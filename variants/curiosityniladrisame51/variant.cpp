...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTA,  19,  PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 }, // SERCOM1 PAD3 MISO // D9
  ...
  // 13 (LED)
  { PORTA,   14, PIO_ANALOG, (PIN_ATTR_ANALOG|PIN_ATTR_PWM_E), ADC_Channel7, TC1_CH1, TC1_CH1, EXTERNAL_INT_7 }, // D3
  ...
  // 18/19 - SERCOM/UART (Serial)
  { PORTA,  8, PIO_SERCOM, PIN_ATTR_PWM_G, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },//SERCOM0 PAD0 TX
  { PORTA,  9, PIO_SERCOM, PIN_ATTR_PWM_G, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },//SERCOM0 PAD1 RX
  ...
  // 38 RX: SERCOM0 PAD1 RX
  { PORTB, 12, PIO_SERCOM_ALT, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // TX: SERCOM4/PAD[0]
  
  // 39 - 40 SPI 0 //
  { PORTA,  16,  PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0}, //SERCOM1 PAD0 MOSI
  { PORTA,  17,  PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_1},  // SERCOM1 PAD1 SCK
  
  // 41 - 44 SPI 1 //
  { PORTB, 8, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0 }, 	// SERCOM4/PAD[0] MOSI
  { PORTB, 9, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_1 }, 	// SERCOM4/PAD[1] SCK
  { PORTB, 11, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 }, 	// SERCOM4/PAD[3] MISO
  { PORTB, 10, PIO_DIGITAL, PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH0, TC5_CH0, EXTERNAL_INT_2 } 	    	    // SERCOM4/PAD[2] SS1
